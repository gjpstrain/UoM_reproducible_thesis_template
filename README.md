Welcome to the unofficial University of Manchester Reproducible Thesis Template. Using `quarto`, `Docker`, and Rstudio.
I wrote my PhD thesis to be entirely open and reproducible. This template is a modification of one written by Alex Casson.
...
# Getting Started
 ...
 - Begin by forking this repository and pulling it into a local folder.
 - Then, read `main.pdf`. This includes more detailed instructions on how to the use the template.
